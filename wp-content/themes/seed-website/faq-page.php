		...
		<div class="row">
			<div class="two-thirds column" style="background-color: white; padding: 2rem 4rem;">
				<div style="border-bottom: solid #f7f7f7 2px;" class="row">
					<p><a style="font-size: 1.4rem; font-weight: 800; text-transform: uppercase; float: left;" href="/seo-faqs/"><i class="fa fa-caret-left" aria-hidden="true"></i>  BACK TO SEO FAQS</a></p>
				</div>
			...
			<div class="one-third column">
				...
				<div style="background-color: white; padding: 2rem 2rem; padding-left: 4rem; margin-top: 2rem;">
					<h6 style="text-transform: uppercase;"><b>Other SEO FAQs</b></h6>
					<?php
					global $post;
